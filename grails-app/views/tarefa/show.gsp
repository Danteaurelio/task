	...
	<body>
		...
		<div id="show-tarefa" class="content scaffold-show" role="main">
			...
			<ol class="property-list tarefa">
				...
				<g:if test="${tarefaInstance?.finalizar}">
				<li class="fieldcontain">
					<span id="finalizar-label" class="property-label"><g:message code="tarefa.finalizar.label" default="Finalizar" /></span>
					
						<span class="property-value" aria-labelledby="finalizar-label"><g:formatDate date="${tarefaInstance?.finalizar}" /></span>
				...
				<li class="fieldcontain">
					<span id="completa-label" class="property-label"><g:message code="tarefa.completa.label" default="Completa" /></span>
					
						<span class="property-value" aria-labelledby="completa-label"><g:formatBoolean boolean="${tarefaInstance?.completa}" /></span>
