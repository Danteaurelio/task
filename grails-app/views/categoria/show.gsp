		...
		<div id="show-categoria" class="content scaffold-show" role="main">
			...
			<ol class="property-list categoria">
				...
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="categoria.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${categoriaInstance}" field="descricao"/></span>
